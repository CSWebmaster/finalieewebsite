...
export default function JourneyDetails() {
  ...
  return (
    <div
      className="h-screen w-screen text-foreground bg-background flex flex-col relative overflow-hidden"
    >
      ...
      <div
        className={`relative z-10 flex flex-col h-full max-w-5xl w-full mx-auto px-4 md:px-8 py-4 md:py-6 transition-all duration-600 ease-out overflow-y-auto ${
